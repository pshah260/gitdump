...
def db_table_delete():
    ...
    for code in stocks.Symbol:
        meta_data = code
        conn_string = "host='localhost' dbname='weekly' user='ai' password='ai'"
...
def insert_table():
    stocks = get_meta()
    engine = create_engine('postgresql://ai:ai@localhost:5432/daily')
    ...
    for code in stocks.Symbol:
        ...
        try:
            ...
            function = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&"
            symbol = "symbol=" + code + "&"
            apikey = "apikey="
            ...
            try:
                ...
                data = rawdata["Daily Adjusted Time Series"]
